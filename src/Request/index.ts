...
export class Request implements IRequest {
  ...
  public method (): string {
    if (this._config.get(ALLOW_METHOD_SPOOFING) && this.intended() === 'POST') {
   ...
   */
  public ip (): string {
    const ipFn = this._config.get(GET_IP)
  ...
  public subdomains (): string[] {
    ...
    const offset = this._config.get(SUBDOMAIN_OFFSET) || 2
